...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue echoInQueueID(){ return new Queue(ECHO_OUT_STATION_QUEUE, false); }

    @Bean
    public Queue echoOUTQUEUEID(){ return new Queue(ECHO_OUT_STATION_DATA_QUEUE, false);}
